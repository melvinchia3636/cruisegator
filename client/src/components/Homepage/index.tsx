		...
		<>
			<div className="mx-8 md:mx-32 w-100 mt-8 md:mt-16 flex flex-col 1170:pb-0 1170:flex-row gap-24 1440:gap-44 justify-between relative 1170:h-[calc(100vh-100px-4rem)]">
				<div className="1170:w-min">
					<h1
						className="text-5xl xl:text-6xl !leading-tight tracking-wide 480:font-bold w-min 480:whitespace-nowrap mb-8 mt-8"
						style={{ textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}
					>
            Travel the world <br className="hidden 480:inline" />
            with <span className="text-blue-800">Cruiseship</span>.
					</h1>
					<p className="text-xl w-[120%] !leading-[149%] text-zinc-400">
            We have every piece of details for any cruiseship in the world. An
            absolute paradise for cruiseship lover to visit.
					</p>
					<div className="flex gap-3">
						<a
							className="font-medium text-lg tracking-wide bg-blue-800 text-white w-64 py-4 whitespace-nowrap justify-center flex items-center mt-20 shadow-md"
							href="/database"
						>
            Explore Database
						</a>
						<a
							className="font-medium text-lg tracking-wide border-2 border-zinc-600 text-zinc-600 w-64 py-4 whitespace-nowrap justify-center flex items-center mt-20 shadow-md"
							href="/database"
						>
            Learn More
						</a>
          ...
          Scroll Down
			...
			<div className="mt-44 px-8 md:px-32 py-28 w-100  bg-blue-50 flex flex-col 1170:flex-row justify-between items-start 1170:items-center gap-24">
				<div>
					<p className="text-blue-800 font-semibold uppercase tracking-widest text-lg mb-2">
            Get Inspired
					</p>
					<h2 className="font-bold text-5xl !leading-[129%] whitespace-nowrap">
            Ideas behind how
						<br />
            this project was
						<br />
            created
				...
				<div className="flex items-start gap-24 1396:gap-0 special">
					<div className="flex">
						<div
							className="bg-blue-800 rounded-full p-4 h-[min-content]"
						>
							<svg
								width="37"
								height="37"
							...
							>
								<path
									d="M23.125 10.4062C23.7636 10.4062 24.2812 9.88858 24.2812 9.25C24.2812 8.61142 23.7636 8.09375 23.125 8.09375C22.4864 8.09375 21.9688 8.61142 21.9688 9.25C21.9688 9.88858 22.4864 10.4062 23.125 10.4062Z"
									fill="#F6F5F7"
								/>
								<path
									d="M26.5938 10.4062C27.2323 10.4062 27.75 9.88858 27.75 9.25C27.75 8.61142 27.2323 8.09375 26.5938 8.09375C25.9552 8.09375 25.4375 8.61142 25.4375 9.25C25.4375 9.88858 25.9552 10.4062 26.5938 10.4062Z"
									fill="#F6F5F7"
								/>
								<path
									d="M30.0625 10.4062C30.7011 10.4062 31.2188 9.88858 31.2188 9.25C31.2188 8.61142 30.7011 8.09375 30.0625 8.09375C29.4239 8.09375 28.9062 8.61142 28.9062 9.25C28.9062 9.88858 29.4239 10.4062 30.0625 10.4062Z"
									fill="#F6F5F7"
								/>
								<path
									d="M32.375 4.625H4.625C4.01187 4.62561 3.42404 4.86945 2.99049 5.30299C2.55695 5.73654 2.31311 6.32437 2.3125 6.9375V30.0625C2.31311 30.6756 2.55695 31.2635 2.99049 31.697C3.42404 32.1306 4.01187 32.3744 4.625 32.375H32.375C32.9881 32.3744 33.576 32.1306 34.0095 31.697C34.4431 31.2635 34.6869 30.6756 34.6875 30.0625V6.9375C34.6869 6.32437 34.4431 5.73654 34.0095 5.30299C33.576 4.86945 32.9881 4.62561 32.375 4.625ZM32.375 6.9375V11.5625H4.625V6.9375H32.375ZM4.625 13.875H11.5625V30.0625H4.625V13.875ZM13.875 30.0625V13.875H32.375V30.0625H13.875Z"
									fill="#F6F5F7"
								/>
							</svg>
						</div>
						<div className="ml-6 mt-4 mr-8">
							<h2 className="font-medium text-[2rem] sm:text-3xl whitespace-nowrap">
                UI Designing
							</h2>
							<p className="text-lg text-zinc-400 mt-4 leading-[153%]">
                Open Figma, casually choose a color theme, pick some
                illustrations, and start designing.
							</p>
						</div>
					</div>
					<div className="flex">
						...
						>
							...
							>
								<path
									d="M35.8437 18.5L27.7499 26.5938L26.1196 24.9634L32.5715 18.5L26.1196 12.0366L27.7499 10.4062L35.8437 18.5Z"
									fill="white"
								/>
								<path
									d="M1.15625 18.5L9.25 10.4062L10.8803 12.0366L4.42844 18.5L10.8803 24.9634L9.25 26.5938L1.15625 18.5Z"
									fill="white"
								/>
								<path
									d="M14.36 29.4659L20.3957 6.9375L22.6295 7.53644L16.5928 30.0625L14.36 29.4659Z"
									fill="white"
								/>
							</svg>
						</div>
						<div className="ml-6 mt-4">
							<h2 className="font-medium text-[2rem] sm:text-3xl">
                Code Writing
							</h2>
							<p className="text-lg mt-4 text-zinc-400 leading-[153%]">
                Get your code editor up and running, initialize a react project,
			...
			<div className="px-8 md:px-32 py-28 pb-14 w-100">
				<p className="text-blue-800 text-center mt-8 font-semibold uppercase tracking-widest text-lg">
          Features
				</p>
				<h1
					className="text-4xl md:text-5xl 2xl:px-72 font-bold !leading-[129%] mb-4 mt-2 text-center"
					style={{ textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}
				>
          What makes this project so interesting?
				</h1>
				<p className="text-center text-xl mt-2 text-zinc-400">
          A not really small project made by a normal guy... Yeah pretty normal.
				</p>
				<div className="mt-16 md:mt-24 grid gap-8 sm:grid-cols-[repeat(auto-fit,minmax(350px,1fr))]">
					<div className="flex p-12 flex-col items-center justify-center border-2 border-zinc-600">
						<svg
							width="59"
							height="59"
							viewBox="0 0 59 59"
              ...
              Presenting data scraped from other websites in a good way
					...
					<div className="inline-flex p-12 flex-col items-center justify-center border-2 border-zinc-600">
						...
						<p className="mt-6 text-lg text-center">
              Explore the source code, do contribution to make it better
						</p>
					</div>
					<div className="inline-flex p-12 flex-col items-center justify-center  border-2 border-zinc-600">
						<svg
						...
						>
							<path
								d="M49.8438 6.34375H8.15625C7.15371 6.34375 6.34375 7.15371 6.34375 8.15625V49.8438C6.34375 50.8463 7.15371 51.6562 8.15625 51.6562H49.8438C50.8463 51.6562 51.6562 50.8463 51.6562 49.8438V8.15625C51.6562 7.15371 50.8463 6.34375 49.8438 6.34375ZM10.4219 10.4219H18.125V47.5781H10.4219V10.4219ZM47.5781 47.5781H21.75V21.75H47.5781V47.5781ZM21.75 18.125V10.4219H47.5781V18.125H21.75Z"
								fill="#4189DD"
							/>
						</svg>
						<h2 className="font-medium mt-9 text-2xl">Great UI Design</h2>
						<p className="mt-6 text-lg text-center">
              Not the best design in the world, but definitely a good one
						</p>
					</div>
				</div>
				<div className="flex justify-center mt-12">
					<a className="border-2 border-zinc-600 text-zinc-600 py-4 px-12 inline-block mt-8 font-medium tracking-[3.5px] uppercase z-40 relative w-min whitespace-nowrap shadow-default">
						<span className="relative z-20 text-zinc-600 text-lg">
              Explore Database
						</span>
					</a>
				</div>
			...
			<div className="px-8 sm:px-16 md:px-32 pb-14 pt-0 w-100 mt-12">
				<div className="flex flex-col 1170:flex-row justify-between items-center mb-20 1170:gap-28">
					<div className="w-full" style={{ flexShrink: 1 }}>
						<img src={illu1} className="w-full" />
					</div>
					<div>
						<p className="text-blue-800 mb-4 font-semibold uppercase tracking-widest">
              Mapbox GL
						</p>
						<h2 className="text-4xl font-semibold leading-[129%]">
              Realtime updated cruiseship location map
						</h2>
						<p className="text-lg mt-6 text-zinc-400">
              See the current location of all the ships over the whole world
              updating in realtime. World map powered by MapboxGL JS.
						</p>
						<a className="font-semibold text-xl text-blue-800 flex items-center mt-10">
              Explore map
							<svg
								className="ml-4 mt-0.5 hidden xl:block w-5 h-5"
								width="24"
								height="24"
								viewBox="0 0 24 24"
								fill="none"
							...
							<svg
								className="ml-2 mt-0.5 block xl:hidden w-5 h-5"
								width="20"
								height="20"
								viewBox="0 0 24 24"
								fill="none"
				...
				<div className="flex flex-col 1170:flex-row justify-between items-center mb-20 1170:gap-28">
					<div className="w-full block 1170:hidden" style={{ flexShrink: 1 }}>
						<img src={illu2} />
					</div>
					<div>
						<p className="text-blue-800 mb-4 font-semibold uppercase tracking-widest">
              Express JS
						...
						<h2 className="text-4xl font-semibold leading-[129%]">
              REST API for everything you see here
						</h2>
						<p className="text-lg mt-6 text-zinc-400">
              Use the data in our website for your own project. We allow you to
              legally scrape all the data you can see in our website.
						</p>
						<a className="font-semibold text-xl text-blue-800 flex items-center mt-10">
              Get started
							<svg
              ...
              React Redux
						...
						<h2 className="text-4xl font-semibold leading-[129%]">
              Latest news of cruiseship insustries
						</h2>
						<p className="text-lg mt-6 text-zinc-400">
              Check out the current trends in cruiseship industries so that you
              will not miss anything important about it.
						</p>
						<a className="font-semibold text-xl text-blue-800 flex items-center mt-10">
              Take a gander
							<svg
			...
			<div className="px-8 sm:px-16 md:px-32 py-28 w-100 bg-blue-700 flex flex-col xl:flex-row justify-between items-center gap-24 2xl:gap-0">
				<div className="flex flex-col items-center xl:items-start xl:w-6/12">
					<h1
						className="text-4xl xl:text-5xl font-semibold !leading-[129%] mb-8 text-center xl:text-left"
						style={{ textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}
					>
						<span className="text-blue-800">Technologies</span> used
						<br />
            in this project
					</h1>
					<p className="text-xl text-center xl:text-left w-full text-zinc-400">
            A total of 4 different technologies and languages has been used for
            this project.
					</p>
					<a
						className="text-blue-800 border-2 border-blue-800 mt-12 font-medium btn-anim2 !px-24 whitespace-nowrap"
						data-text="VIEW REPOSITORY"
						href="https://github.com/melvinchia3636/cruisegator"
					>
						{"GOTO GITHUB".split("").map((e) => (
							<span className="text-white" key={e}>
								{e}
							</span>
						))}
					</a>
				...
				<div
					className="grid w-full sm:w-auto sm:grid-cols-2 items-center gap-4 mt-4 xl:mt-0"
					style={{ gridAutoRows: "1fr" }}
				>
					<div className="border-2 border-blue-800 p-6 h-full flex flex-col justify-between">
						<div>
							<svg
								width="56"
								height="56"
              ...
              LEARN MORE
					...
					<div className="border-2 border-blue-800 p-6 h-full flex flex-col justify-between">
						<div>
							...
							<p className="mt-4 max-w-[18rem] leading-[153%]">
                A back end web application framework for Node.js, released as
              ...
              LEARN MORE
					...
					<div className="border-2 border-blue-800 p-6 h-full flex flex-col justify-between">
						<div>
							...
							<p className="mt-4 max-w-[18rem] leading-[153%]">
                An open-source JavaScript library for managing application
                state.
							</p>
						</div>
						<a
			...
			<div className="px-8 sm:px-16 md:px-32 py-28 w-100">
				<h1
					className="text-4xl md:text-5xl 2xl:px-72 font-semibold !leading-[129%] mb-4 mt-8 text-center"
					style={{ textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}
				>
          Upgrade to <span className="text-blue-800">Premium</span> with
          affordable price
				</h1>
				<p className="text-center text-xl text-zinc-400">
          This is just a decoration. This site is completely free to use.
				</p>
				<div className="mt-12 xl:mt-24 flex items-center justify-center flex-col xl:flex-row gap-6 xl:gap-0 ">
					<div className="rounded-r-lg xl:rounded-r-none rounded-l-lg bg-white p-6 w-full xl:w-96 shadow-default">
						...
						<h2 className="text-blue-800 font-semibold text-7xl my-6">
              $9 <span className="text-blue-800 text-2xl">/ month</span>
						</h2>
						<p className="text-lg">
              Wanna buy me a coffee in order for me to more projects?
						</p>
						<div className="py-6">
                ...
                Some tutorials maybe
						...
						<a className="w-full py-4 bg-blue-800 text-white rounded-lg flex justify-center text-center font-semibold text-xl white shadow-default">
              Get started
						</a>
					</div>
					<div className="bg-blue-800 rounded-lg p-6 w-full xl:w-[28rem] shadow-default">
						<div className="flex justify-end">
							<p className="block bg-white text-md px-8 py-2 rounded-full text-blue-800 font-semibold shadow-default">
                Popular
							</p>
						</div>
						<p className="text-white font-medium text-2xl mt-4">Professional</p>
						<h2 className="text-white font-semibold text-7xl my-6">
              $19 <span className="text-white text-2xl">/ month</span>
						</h2>
						<p className="text-white text-lg border-white border-b-[1px] pb-6">
              This looks professional so you should definitely buy it for no
              reason :)
						</p>
                ...
                A UI design service
						...
						<a className="w-full py-4 bg-white rounded-lg flex justify-center text-center font-semibold text-xl text-blue-800 shadow-default">
              Get started
						</a>
					</div>
					<div className="rounded-l-lg xl:rounded-l-none bg-white rounded-r-lg p-6 w-full xl:w-96 shadow-default">
						...
						<h2 className="text-blue-800 font-semibold text-7xl my-6">
              $59 <span className="text-blue-800 text-2xl">/ month</span>
						</h2>
						<p className="text-lg">
              Are you still finding a way to spend your money? XD
						</p>
						<div className="py-6">
							<p className="flex text-blue-800 items-center text-lg font-semibold py-4">
								<svg
			...
			<div className="px-8 sm:px-16 md:px-32 1170:!px-32 py-28 w-100 bg-blue-700 flex flex-col lg:flex-row justify-between items-center gap-16 xl:gap-32">
				<div className="w-full flex-shrink-[9999] md:h-[500px]">
					<img
						src={img}
						className="w-full h-full mr-32 rounded-tr-[3rem] rounded-bl-[3rem] md:rounded-tr-[5rem] md:rounded-bl-[5rem] sm:min-w-[300px]"
					/>
				</div>
				<div>
					<svg
					...
					<h1
						className="text-4xl font-semibold !leading-[129%] mb-8 mt-4"
						style={{ textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}
					>
            A place where you will never want to leave
					</h1>
					<p className="text-lg w-full !leading-[155.5%] text-zinc-400">
            You can never doubt about the fact that most of the cruiseship are
            too luxury until you never wanna leave it. Tons of fancy facilities,
            lots of delicious foods... Aww damn that’s endless afterstate.
					</p>
					<p className="font-semibold text-xl mt-8">
            Melvin Chia, Founder of CG
					</p>
				</div>
			</div>
			<div className="px-8 sm:px-16 md:px-32 py-28 w-100 flex justify-between flex-col xl:flex-row">
				<div className="flex flex-col items-center xl:hidden lg:px-32 mb-12">
					<h1
						className="text-4xl md:text-5xl font-semibold !leading-[129%] mb-8 mt-8 text-center xl:text-left"
						style={{ textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}
					>
            Wanna build <span className="text-blue-800">projects</span> with me?
					</h1>
					<p className="text-lg md:text-xl mt-6 !leading-[155.5%] text-center">
            I’ll be really glad if somebody is willing to learn with me and make
            amazing projects at the mean time
					</p>
				</div>
				<div className="xl:bg-blue-800 xl:xl:px-4 w-full rounded-lg contact relative z-10">
					<div className="bg-white w-full xl:h-[104%] xl:absolute xl:bottom-4 xl:left-4 xl:rounded-lg xl:p-12">
						<form className="flex flex-col h-full">
							<label
								htmlFor="email"
								className="text-blue-800 font-semibold text-md xl:text-lg"
							>
                Email
							</label>
							<input
								className="w-full bg-[#FDFDFD] p-4 rounded-md mt-1 text-lg xl:text-xl"
								id="email"
								type="text"
								name="email"
							...
							<label
								htmlFor="name"
								className="text-blue-800 font-semibold text-md xl:text-lg mt-8"
							>
                Full Name
							</label>
							<input
                ...
                Messages
							...
							<textarea
								className="w-full bg-[#FDFDFD] p-4 rounded-md mt-1 text-lg xl:text-xl h-full min-h-[12rem] xl:min-h-auto"
								id="message"
								name="message"
								placeholder="Say something here"
							/>
							<button
								className="bg-blue-800 rounded-full text-white px-12 inline-block mt-12 font-medium btn-anim2 whitespace-nowrap !w-full"
								data-text="SEND"
							>
								{"LET'S GO".split("").map((e) => (
									<span className="text-white" key={e}>
										{e}
									</span>
								))}
				...
				<div className="ml-32 max-w-[36rem] hidden xl:flex flex-col">
					<h1
						className="text-4xl md:text-5xl font-semibold !leading-[129%] mb-8 mt-8"
						style={{ textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}
					>
            Wanna make <span className="text-blue-800">projects</span> with me?
					</h1>
					<p className="text-lg md:text-xl mt-6 !leading-[155.5%]">
            I’ll be really glad if somebody is willing to learn with me and make
            amazing projects at the mean time
					</p>

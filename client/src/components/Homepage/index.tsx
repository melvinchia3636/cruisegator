  ...
  return (
    <div className="mx-8 md:mx-32 w-100 mt-8 md:mt-16 flex flex-col 1170:pb-0 1170:flex-row gap-24 1440:gap-44 justify-between relative 1170:h-[calc(100vh-100px-4rem)]">
      <div className="1170:w-min">
        <h1
          className="text-5xl xl:text-6xl font-semibold !leading-[129%] w-min 480:whitespace-nowrap mb-8 mt-8"
          style={{
        ...
        <p className="text-xl xl:text-[1.4rem] w-full !leading-[149%]">
          We have every piece of details for any cruiseship in the world. An absolute paradise for
          cruiseship lover to visit.
        </p>
        <a
          className="font-semibold text-2xl text-blue-800 flex items-center mt-20"
          href="/database"
        >
          Explore Database
          <svg
      ...
      <div className="relative w-full">
        <img alt="" src={TopLogo} className="w-full h-full object-cover" />
      ...
      <a href="/" className="absolute bottom-2 left-0 font-medium text-lg hidden 1170:flex">
        <svg
  ...
  return (
    <div className="mt-44 px-8 md:px-32 py-28 w-100 bg-blue-700 flex flex-col 1170:flex-row justify-between items-start 1170:items-center gap-24">
      <div>
        ...
        <h2 className="font-semibold text-4xl sm:text-5xl !leading-[129%] whitespace-nowrap">
          Ideas behind how
          <br />
          this project was
          <br />
      ...
      <div className="flex items-start gap-24 1396:gap-0 special">
        <div className="flex">
          ...
          <div className="ml-6 mt-4 mr-8">
            ...
            <p className="text-lg sm:text-xl mt-4 1024:max-w-[18rem] leading-[153%]">
              Open Figma, casually choose a color theme, pick some illustrations, and start
              designing.
            </p>
          </div>
        </div>
        <div className="flex">
          ...
          <div className="ml-6 mt-4">
            ...
            <p className="text-lg sm:text-xl mt-4 1024:max-w-[18rem] leading-[153%]">
              Get your code editor up and running, initialize a react project, and start writing
              your code.
            </p>
          </div>
        </div>
...
function Features() {
  return (
    <div className="px-8 md:px-32 py-28 pb-14 w-100">
      <h1
        className="text-4xl md:text-5xl 2xl:px-72 font-semibold !leading-[129%] mb-8 mt-8 text-center"
        style={{
          textShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)',
        }}
      >
      ...
      <p className="text-center text-xl md:text-2xl mt-6">
      ...
      <div className="flex justify-center mt-12">
        <a
          href="/database"
          className="bg-blue-800 rounded-full text-white py-4 px-12 inline-block mt-8 font-medium tracking-[3.5px] uppercase btn-white btn btn-animated z-40 relative w-min whitespace-nowrap shadow-default"
        >
          <span className="relative z-20 text-white text-lg">Explore Database</span>
        </a>
      </div>
    </div>
  );
  ...
  return (
    <div className="px-8 sm:px-16 md:px-32 pb-14 pt-0 w-100 mt-12">
      <div className="flex flex-col 1170:flex-row justify-between items-center mb-20 1170:gap-28">
        ...
        >
          <img alt="" src={illu1} className="w-full" />
        </div>
        <div>
          <p className="text-blue-800 font-semibold text-lg xl:text-xl mb-4">Mapbox GL</p>
          <h2 className="text-4xl xl:text-[2.7rem] font-semibold leading-[129%]">
            Realtime updated cruiseship location map
          </h2>
          <p className="text-lg xl:text-xl mt-6">
            See the current location of all the ships over the whole world updating in realtime.
            World map powered by MapboxGL JS.
          </p>
          <a
            href="/map"
            className="font-semibold text-xl xl:text-2xl text-blue-800 flex items-center mt-10"
          >
            Explore map
            <svg
              className="ml-4 mt-0.5 hidden xl:block"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <svg
              className="ml-2 mt-0.5 block xl:hidden"
              width="20"
              height="20"
              viewBox="0 0 24 24"
              fill="none"
      ...
      <div className="flex flex-col 1170:flex-row justify-between items-center mb-20 1170:gap-28">
        <div
          className="w-full block 1170:hidden"
          style={{
            flexShrink: 1,
          }}
        >
        ...
        <div>
          ...
          <p className="text-lg xl:text-xl mt-6">
            Use the data in our website for your own project. We allow you to legally scrape all the
            data you can see in our website.
          </p>
          <a
            href="/"
            className="font-semibold text-xl xl:text-2xl text-blue-800 flex items-center mt-10"
        ...
        <div
          className="w-full hidden 1170:flex"
          style={{
            flexShrink: 1,
          }}
        >
      ...
      <div className="flex flex-col 1170:flex-row justify-between items-center mb-16 1170:gap-28">
        ...
        >
          <img alt="" src={illu3} className="w-full" />
        </div>
        <div>
          ...
          <p className="text-lg xl:text-xl mt-6">
            Check out the current trends in cruiseship industries so that you will not miss anything
            important about it.
          </p>
          <a
            href="/news"
  ...
  return (
    <div className="px-8 sm:px-16 md:px-32 py-28 w-100 bg-blue-700 flex flex-col xl:flex-row justify-between items-center gap-24 2xl:gap-0">
      <div className="flex flex-col items-center xl:items-start xl:w-6/12">
        ...
        <p className="text-xl text-center xl:text-left w-full xl:w-8/12">
          A total of 4 different technologies and languages has been used for this project.
        </p>
        <a
          className="bg-blue-800 rounded-full text-white shadow-default mt-12 font-medium btn-anim2 !px-24 whitespace-nowrap"
      ...
      >
        <div className="shadow-gridbox rounded-[4px] bg-white p-6 h-full flex flex-col justify-between">
          <div>
            ...
            <p className="text-lg mt-4 max-w-[18rem] leading-[153%]">
              A free and open-source front-end JavaScript library for building user interfaces or UI
              components
            </p>
          </div>
          <a className="text-blue-800 font-semibold mt-9 flex" href="https://reactjs.org">
            LEARN MORE
          </a>
        </div>
        <div className="shadow-gridbox rounded-[4px] bg-white p-6 h-full flex flex-col justify-between">
          <div>
            ...
            <p className="text-lg mt-4 max-w-[18rem] leading-[153%]">
              A back end web application framework for Node.js, released as free and open-source
              software under the MIT License.
            </p>
          </div>
          <a className="text-blue-800 font-semibold mt-9 flex" href="https://expressjs.com">
            LEARN MORE
          </a>
        </div>
        <div className="shadow-gridbox rounded-[4px] bg-white p-6 h-full flex flex-col justify-between">
          ...
          <a className="text-blue-800 font-semibold mt-9 flex" href="https://react-redux.js.org">
            LEARN MORE
          </a>
        </div>
        <div className="shadow-gridbox rounded-[4px] bg-white p-6 h-full flex flex-col justify-between">
  ...
  return (
    <div className="px-8 sm:px-16 md:px-32 py-28 w-100">
      ...
      <p className="text-center text-xl md:text-2xl mt-12">
        This is just a decoration. I don’t want your money.
      </p>
      <div className="mt-12 xl:mt-24 flex items-center justify-center flex-col xl:flex-row gap-6 xl:gap-0 ">
        <div className="rounded-r-lg xl:rounded-r-none rounded-l-lg bg-white p-6 w-full xl:w-96 shadow-default">
          ...
          <a
            href="/"
            className="w-full py-4 bg-blue-800 text-white rounded-lg flex justify-center text-center font-semibold text-xl white shadow-default"
          >
            Get started
          </a>
        </div>
        <div className="bg-blue-800 rounded-lg p-6 w-full xl:w-[28rem] shadow-default">
          ...
          <p className="text-white text-lg border-white border-b-[1px] pb-6">
            This looks professional so you should definitely buy it for no reason :)
          </p>
          ...
          <a
            href="/"
            className="w-full py-4 bg-white rounded-lg flex justify-center text-center font-semibold text-xl text-blue-800 shadow-default"
          >
            Get started
          </a>
        </div>
  ...
  return (
    <div className="px-8 sm:px-16 md:px-32 1170:!px-32 py-28 w-100 bg-blue-700 flex flex-col lg:flex-row justify-between items-center gap-16 xl:gap-32">
      ...
      <div>
        ...
        <h1
          className="text-4xl xl:text-5xl font-semibold !leading-[129%] mb-8 mt-4"
          style={{
            textShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)',
          }}
        >
        ...
        <p className="text-lg xl:text-xl w-full !leading-[155.5%]">
          You can never doubt about the fact that most of the cruiseship are too luxury until you
          never wanna leave it. Tons of fancy facilities, lots of delicious foods... Aww damn that’s
          endless afterstate.
        </p>
    ...
    <div className="px-8 sm:px-16 md:px-32 py-28 w-100 flex justify-between flex-col xl:flex-row">
      <div className="flex flex-col items-center xl:hidden lg:px-32 mb-12">
        ...
        <p className="text-lg md:text-xl mt-6 !leading-[155.5%] text-center">
          I’ll be really glad if somebody is willing to learn with me and make amazing projects at
          the mean time
        </p>
      </div>
      <div className="xl:bg-blue-800 xl:shadow-default xl:px-4 w-full rounded-lg contact relative z-10">
        <div className="bg-white w-full xl:h-[104%] xl:absolute xl:bottom-4 xl:left-4 xl:shadow-default rounded-lg xl:p-12">
          <form className="flex flex-col h-full">
            <label htmlFor="email" className="text-blue-800 font-semibold text-md xl:text-lg">
              Email
            </label>
            <input
              className="w-full bg-[#FDFDFD] shadow-form p-4 rounded-md mt-1 text-lg xl:text-xl"
              id="email"
              type="text"
              name="email"
              placeholder="johndoe@gmail.com"
            />
            <label htmlFor="name" className="text-blue-800 font-semibold text-md xl:text-lg mt-8">
              Full Name
            </label>
            <input
              className="w-full bg-[#FDFDFD] shadow-form p-4 rounded-md mt-1 text-lg xl:text-xl"
            ...
            <textarea
              className="w-full bg-[#FDFDFD] shadow-form p-4 rounded-md mt-1 text-lg xl:text-xl h-full min-h-[12rem] xl:min-h-auto"
              id="message"
              name="message"
            ...
            <button
              type="button"
              className="bg-blue-800 rounded-full text-white px-12 shadow-default inline-block mt-12 font-medium btn-anim2 whitespace-nowrap !w-full"
              data-text="SEND"
            >
      ...
      <div className="ml-32 max-w-[36rem] hidden xl:flex flex-col">
        ...
        <img alt="" src={illu4} className="w-full" />
      </div>
    </div>
  );
}

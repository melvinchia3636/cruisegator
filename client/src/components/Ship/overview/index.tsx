  ...
  return (
    <div className="px-32 mb-32 mt-16 w-full overflow-hidden flex flex-col overview">
      <div className="flex justify-between items-center">
        <div className="w-min">
          <h1
            className="text-4xl xl:text-5xl font-semibold !leading-[129%] w-min 480:whitespace-nowrap mb-8"
            style={{ textShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}
          >
            Some <span className="text-blue-800">size information</span>
            <br />
            about the ship
          </h1>
          ...
          <button
            type="button"
            onClick={() => changeTab(1)}
            className="font-semibold text-xl xl:text-2xl cursor-pointer text-blue-800 flex items-center mt-10"
          >
            See specifications
            <svg
        ...
        <div className="flex flex-col items-center gap-20">
          <div className="flex gap-24">
            <div>
              {specification_data.specification_data['Beam (width)'] ? (
                <Anime
                  initial={[
                    {
                      targets: '.height',
                ...
                >
                  <p className="font-semibold height text-7xl text-center" />
                </Anime>
              ) : (
                <p className="font-semibold text-7xl text-center">N/A</p>
              )}
            ...
            <div>
              {specification_data.specification_data['Beam (width)'] ? (
                  ...
                  initial={[
                    {
                      ...
                      innerHTML: [
                        '0m',
                        `${parseInt(
                          specification_data.specification_data['Length (LOA)']
                            ?.split('/')[0]
                            ?.trim(),
                          10,
                        )}m`,
                ...
                >
                  <p className="font-semibold width text-7xl text-center" />
                </Anime>
              ) : (
                <p className="font-semibold text-7xl text-center">N/A</p>
              )}
          ...
          <div>
            {specification_data.specification_data['Beam (width)'] ? (
                ...
                initial={[
                  {
                    ...
                    innerHTML: [
                      '0m',
                      `${parseInt(
                        specification_data.specification_data['Gross Tonnage']
                          ?.split('/')[0]
                          ?.trim(),
                        10,
                      ).toLocaleString()}gt`,
              ...
              >
                <p className="font-semibold gross-tonnage text-7xl text-center" />
              </Anime>
            ) : (
              <p className="font-semibold text-7xl text-center">N/A</p>
            )}
      ...
      {data.homeports.length ? (
        <div className="mt-32 w-full flex flex-col items-center">
          <h1
            className="text-4xl text-center xl:text-5xl font-semibold !leading-[129%] w-min 480:whitespace-nowrap mb-8"
            style={{ textShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}
          >
            The <span className="text-blue-800">homeports</span> where
            <br />
            the ship stays
          </h1>
          ...
          <div className="gap-x-44 gap-y-16 flex mt-20 flex-wrap items-center justify-center">
            {data.homeports.map((e) => (
              <div className="flex flex-col items-center justify-center" key={e.text[0]}>
                <span className={`!w-32 !h-24 rounded-lg ${e.icon}`} />
                <p className="text-3xl font-medium text-center whitespace-nowrap mt-4">
                  {e.text[1]}
                </p>
      ...
      {data.position.lon !== 0 && data.position.lat !== 0 && (
